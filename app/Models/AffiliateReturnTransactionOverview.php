...
class AffiliateReturnTransactionOverview extends Model
{
    protected $table = "tbl_affiliate_return_transaction_overviews";

    protected $guarded = [];

    public function affiliateTransactionReturnOverviews($affiliate,$month)
    {
        $year = date('Y');
        $reqest_month = $month;
