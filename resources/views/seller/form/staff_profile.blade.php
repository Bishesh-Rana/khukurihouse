...
<form method="POST" id="upload_form" action="{{ route('staff.profile.update', $staff->id) }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row">
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                ...
                <hr>
                <img id="profile" src="{{ asset('uploads/'.'sellers/'.$staff->image) }}" alt="<?php if (isset($staff->first_name)) {
                                                                                    echo $staff->first_name;
