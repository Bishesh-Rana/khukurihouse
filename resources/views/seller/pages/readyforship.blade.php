...
Ready For Shipping Detail | {{env('APP_NAME')}}
...
<div class="page-heading">
    ...
    <ol class="breadcrumb">
        ...
        <a class="btn btn-outline-primary" href="{{ route('seller.order.ready.shipping.list') }}"><i class="fa fa-step-backward"></i>  BACK</a>
