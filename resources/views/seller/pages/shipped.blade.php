...
<div class="page-heading">
    <h1 class="page-title">Shipped Information</h1>
    <ol class="breadcrumb">
        <li class="breadcrumb-item">
            <a href="index.html"><i class="la la-home font-20"></i></a>
        </li>
        <a class="btn btn-outline-primary" href="{{ route('seller.order.shipped.list') }}"><i class="fa fa-step-backward"></i>  BACK</a>
        
        {{-- <a class="btn btn-outline-primary" href="{{ route('seller.order.delievered.update', $user_info->ref_id) }}"><i class="fa fa-plus"></i>Delievered</a> &nbsp;&nbsp;
        <a class="btn btn-outline-primary" href="{{ route('seller.order.cancel_delievered.update', $user_info->ref_id) }}"><i class="fa fa-plus"></i>Cancel Deliever</a> --}}
