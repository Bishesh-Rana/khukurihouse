                                ...
                                <form method="POST" id="upload_form"  enctype="multipart/form-data">
                                    ...
                                    <div class="photo-section" style="width:240px;">
                                        <div class="photo-place">
                                            ...
                                            <div class="product-images-search-icon">
                                                ...
                                                <a title="Delete" class="btn btn-danger btn-circle btn-xs" href="{{ route('seller.product.manage.img.delete', $row->images[0]->id) }}" onclick="return confirm('Do You Really Wanna Delete?')"><i class="fa fa-times"></i></a>
                                            </div>
                                        ...
                                        <div class="photo-section" style="width:240px;">
                                            <div class="photo-place">
                                                ...
                                                <div class="product-images-search-icon">
                                                    ...
                                                    <a title="Delete" class="btn btn-danger btn-circle btn-xs" href="{{ route('seller.product.manage.img.delete', $row->images[1]->id) }}" onclick="return confirm('Do You Really Wanna Delete?')"><i class="fa fa-times"></i></a>
                                                </div>
                                                @endif
                                            </div>
                                        </form>
                                            ...
                                            <div class="photo-section" style="width:240px;">
                                                <div class="photo-place">
                                                    ...
                                                    <div class="product-images-search-icon">
                                                        ...
                                                        <a title="Delete" class="btn btn-danger btn-circle btn-xs" href="{{ route('seller.product.manage.img.delete', $row->images[2]->id) }}" onclick="return confirm('Do You Really Wanna Delete?')"><i class="fa fa-times"></i></a>
                                                    </div>
                                                    @endif
                                                </div>
                                            </form>
                                                ...
                                                <div class="photo-section" style="width:240px;">
                                                    <div class="photo-place">
                                                        ...
                                                        <div class="product-images-search-icon">
                                                            ...
                                                            <a title="Delete" class="btn btn-danger btn-circle btn-xs" href="{{ route('seller.product.manage.img.delete', $row->images[3]->id) }}" onclick="return confirm('Do You Really Wanna Delete?')"><i class="fa fa-times"></i></a>
                                                        </div>
                                                        @endif
                                                    </div>
                                                </form>
                                                    ...
                                                    <div class="photo-section" style="width:240px;">
                                                        <div class="photo-place">
                                                            ...
                                                            <div class="product-images-search-icon">
                                                                ...
                                                                <a title="Delete" class="btn btn-danger btn-circle btn-xs" href="{{ route('seller.product.manage.img.delete', $row->images[4]->id) }}" onclick="return confirm('Do You Really Wanna Delete?')"><i class="fa fa-times"></i></a>
                                                            </div>
                                                            @endif
                                                        </div>
                                                    </form>
                                                        ...
                                                        <div class="photo-section" style="width:240px;">
                                                            <div class="photo-place">
                                                                ...
                                                                <div class="product-images-search-icon">
                                                                    ...
                                                                    <a title="Delete" class="btn btn-danger btn-circle btn-xs" href="{{ route('seller.product.manage.img.delete', $row->images[5]->id) }}" onclick="return confirm('Do You Really Wanna Delete?')"><i class="fa fa-times"></i></a>
                                                                </div>
                                                                @endif
                                                            </div>
                                                        </form>
                                                            ...
                                                            <div class="photo-section" style="width:240px;">
                                                                <div class="photo-place">
                                                                    ...
                                                                    <div class="product-images-search-icon">
                                                                        ...
                                                                        <a title="Delete" class="btn btn-danger btn-circle btn-xs" href="{{ route('seller.product.manage.img.delete', $row->images[6]->id) }}" onclick="return confirm('Do You Really Wanna Delete?')"><i class="fa fa-times"></i></a>
                                                                    </div>
                                                                    @endif
                                                                </div>
                                                            </form>
                                                                ...
                                                                <div class="photo-section" style="width:240px;">
                                                                    <div class="photo-place">
                                                                        ...
                                                                        <div class="product-images-search-icon">
                                                                            ...
                                                                            <a title="Delete" class="btn btn-danger btn-circle btn-xs" href="{{ route('seller.product.manage.img.delete', $row->images[7]->id) }}" onclick="return confirm('Do You Really Wanna Delete?')"><i class="fa fa-times"></i></a>
                                                                        </div>
                                                                        @endif
                                                                    </div>
                                                                </form>
                                    ...
                                    <script>
                                        ...
                                        function image(formData){
                                            $.ajax({
                                                url: "{{ route('seller.manage.productimage')}}",
                                                method: "POST",
                                                data: formData,
                                                dataType: 'JSON',
                                                contentType: false,
