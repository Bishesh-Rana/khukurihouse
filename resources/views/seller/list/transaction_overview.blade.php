...
Transaction Overview | {{env('APP_NAME')}}
...
<div class="page-heading">
    <h1 class="page-title">Transaction Overviews</h1>
    <ol class="breadcrumb">
...
<div class="page-content fade-in-up">
    <div class="ibox">
        ...
        <div class="ibox-body">
            ...
            <div id="table-data">
                @include('seller.list.ajaxlist.transaction_overview')
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $(document).on('click', '.pagination a', function(e) {
            ...
            filterObject.path = "{{ URL::route('fetch.seller.transaction.overview') }}?page="+filterObject.page;
            serverRequest();
        });
