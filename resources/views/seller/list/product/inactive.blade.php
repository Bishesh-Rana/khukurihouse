...
<div class="page-heading" style="margin-top:14px;">
    ...
    <div class="page-content fade-in-up">
        <div class="ibox">
            <div class="ibox-head">
                <div class="ibox-title">Inactive Product</div>
            </div>
            <div class="ibox-body">
                @include('admin.layouts.error')
                
                <div id="table-data">
                    @include('seller.list.ajaxproduct.inactive')
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $(document).on('click', '.pagination a', function(e) {
            ...
            filterObject.path = "{{ URL::route('seller.product.inactive.ajaxfetch') }}?page="+filterObject.page;
            serverRequest();
        });
