...
<div class="page-content fade-in-up">
    <div class="ibox">
        <div class="ibox-head">
            <div class="ibox-title">Shiped List</div>
        </div>
        <div class="ibox-body">
            ...
            <div id="table-data">
                @include('seller.list.ajaxorder.shipped')
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $(document).on('click', '.pagination a', function(e) {
            ...
            filterObject.path = "{{ route('seller.ajax.shipped') }}?page="+filterObject.page;
            serverRequest();
        });
