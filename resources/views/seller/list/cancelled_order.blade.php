...
Cancelled Order List | {{env('APP_NAME')}}
...
<div class="page-content fade-in-up">
    <div class="ibox">
        <div class="ibox-head">
            <div class="ibox-title">Cancelled Order List</div>
        </div>
        <div class="ibox-body">
            ...
            <div id="table-data">
                @include('seller.list.ajaxorder.cancelledorder')
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $(document).on('click', '.pagination a', function(e) {
            ...
            filterObject.path = "{{ route('seller.ajax.ordercancel') }}?page="+filterObject.page;
            serverRequest();
        });
