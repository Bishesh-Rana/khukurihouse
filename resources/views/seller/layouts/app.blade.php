                ...
                <ul class="nav navbar-toolbar">
                    ...
                    <li class="dropdown dropdown-user">
                        <a class="nav-link dropdown-toggle link" data-toggle="dropdown">
                           @if(isset(Auth::guard('seller')->user()->image))
                            <img src="{{asset('')}}uploads/sellers/{{Auth::guard('seller')->user()->image}}" />
                            @endif
                            <span></span>{{Auth::guard('seller')->user()->first_name}}<i class="fa fa-angle-down m-l-5"></i></a>
                        <ul class="dropdown-menu dropdown-menu-right">
                            @php
                            if(Auth::guard('seller')->user()->parent_id !=''){
                                $path = route('staff.profile.show');
                            }
                            else{
                                $path = route('seller.profile.show');
                            }
                            @endphp
                            ...
                            <a class="dropdown-item" href="{{url('ns-seller/logout')}}"><i class="fa fa-power-off"></i>Logout</a>
                        </ul>
                    </li>
                </ul>
