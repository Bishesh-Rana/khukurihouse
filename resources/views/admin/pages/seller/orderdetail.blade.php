...
Seller Order List | {{env('APP_NAME')}}
            ...
            <div class="ibox">
                <div class="ibox-body">
                    ...
                    <h4 class="text-info m-b-20 m-t-20">
                        <i class="fa fa-shopping-basket"></i> Order List | Total Sold:: {{$orders->total()}}
                    </h4>
                    <div id="table-data">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.pagination a', function(e) {
                ...
                filterObject.path = "{{ URL::route('admin.fetch.seller.order-history') }}?page=" + filterObject.page;
                serverRequest();
            });
