...
@section('content')
    ...
    <div class="page-heading">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="{{ url('/ns-admin/products') }}">Go Back<i class="la la-home font-20"></i></a>
            </li>
        </ol>
    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <img src="{{ asset('') }}uploads/products/{{ $product->image }}"
                                    alt="{{ $product->product_name }}" height="200px" height="200px">
                            </td>
                        </tr>
                    </tbody>
                </table>
    ...
    <div id="printpage"
        style="border:1px solid;border-style: inset;border-radius: 5px;margin: 0px auto; text-align:center;">
        <div id="detail">
    ...
    <div class="text-right">
        <button class="btn btn-info" type="button" onclick="printDiv()"><i class="fa fa-print"></i> Print Product QR
            Code</button>
    </div>
@stop
@section('footer')
