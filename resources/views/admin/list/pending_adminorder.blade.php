...
<div class="page-content fade-in-up">
    <div class="ibox">
        <div class="ibox-head">
            <div class="ibox-title">Admin : Pending Orders</div>
        </div>
        <div class="ibox-body">
            ...
            <div id="table-data">
                @include('admin.list.ajaxlist.pending_admin_order')
 ...
 let filterObject = {
       ...
       $(document).ready(function(){
        $(document).on('click', '.pagination a', function(e) {
            ...
            filterObject.path = "{{ URL::route('admin.list.admin.order.fetch') }}?page="+filterObject.page;
            serverRequest();
        });
