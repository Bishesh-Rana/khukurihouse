...
<div class="page-content fade-in-up">
    <div class="ibox">
        <div class="ibox-head">
            <div class="ibox-title">Ready To Ship</div>
        </div>
        <div class="ibox-body">
            ...
            <div id="table-data">
                @include('admin.list.ajaxlist.adminreadyforship')
 ...
 let filterObject = {
       ...
       $(document).ready(function(){
        $(document).on('click', '.pagination a', function(e) {
            ...
            filterObject.path = "{{ URL::route('ajax.admin.order.ready.shipping.list.fetch') }}?page="+filterObject.page;
            serverRequest();
        });
