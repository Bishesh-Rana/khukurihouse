...
<div class="ibox">
    ...
    <div class="ibox-body">
        <form class="form-inline">
            ...
            <div class="col-sm-3 form-group">
                <label for="transaction_type">For the Affiliate List</label>

                <select class="form-control select2_demo_1" id="affiliate_id" name="affiliate_id">
...
<div class="page-content fade-in-up">
    <div class="ibox">
        ...
        <div class="ibox-body">
            ...
            <div id="table-data">
                @include('admin.list.ajaxlist.affiliate_transaction_overview')
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.pagination a', function(e) {
            ...
            filterObject.path = "{{ URL::route('admin.fetch.affiliate.transaction.overview') }}?page=" + filterObject.page;
            serverRequest();
        });
