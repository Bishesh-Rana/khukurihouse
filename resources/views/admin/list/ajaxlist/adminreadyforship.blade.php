<table class="table table-striped table-bordered table-hover" id="" cellspacing="0" width="100%">
    ...
    <tbody>
        ...
        <td>{{ $row->ref_id }}</td>
            ...
            <td>
            <a href="{{ route('admin.order.ready.shipping.view', $row->ref_id)}}"> <span class="badge badge-primary m-r-5 m-b-5">View</span></a>
            <a href="{{   route('admin.order.shipped', $row->ref_id) }}"></i><span class="badge badge-success m-r-5 m-b-5">Dispatch Order</span></a>
