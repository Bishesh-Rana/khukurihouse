...
<div class="page-content fade-in-up">
    <div class="ibox">
        ...
        <div class="ibox-body">
            ...
            <div id="table-data">
                @include('admin.list.ajaxlist.admincancelled_order')
 ...
 let filterObject = {
       ...
       $(document).ready(function(){
        $(document).on('click', '.pagination a', function(e) {
            ...
            filterObject.path = "{{ URL::route('admin.ajax.ordercancel.fetch') }}?page="+filterObject.page;
            serverRequest();
        });
