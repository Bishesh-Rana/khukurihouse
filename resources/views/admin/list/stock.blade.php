...
<div class="ibox">
    <div class="ibox-head">
        <div class="ibox-title">Search Stock Product</div>
    </div>
    <div class="ibox-body">
...
<div class="page-content fade-in-up">
    <div class="ibox">
        ...
        <div class="ibox-body">
            ...
            <div id="table-data">
                @include('admin.list.ajaxlist.stock')
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $(document).on('click', '.pagination a', function(e) {
            ...
            filterObject.path = "{{ URL::route('admin.stock.ajaxfetch') }}?page="+filterObject.page;
            serverRequest();
        });
