...
<head>
    ...
    <title>{{$setting->site_name}} | Admin Forgot Password</title>
...
<body class="bg-silver-300">
    ...
    <div class="content">
        ...
        <form role="form" method="POST" action="{{ route('admin.password.email') }}">
            @csrf
            <h2 class="login-title">Admin Forgot Password</h2>
            <div class="form-group">
                <div class="input-group-icon right">
                    <div class="input-icon"><i class="fa fa-envelope"></i></div>
                    <input class="form-control" type="email" name="email" id="email" placeholder="Email" autocomplete="off" required autofocus>
                </div>
            </div>
