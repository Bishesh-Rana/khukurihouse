...
<body>
    ...
    <table>
        ...
        <tr>
            <td>Subtotal</td>
            <td colspan="2">Rs. {{number_format($payment->total_price)}}</td>
        </tr>
        <tr>
            <td>Delivery Charge</td>
            <td  colspan="2">Rs. {{number_format($payment->delivery_cost)}}</td>
        </tr>
        <tr>
            <td>Discount Amount</td>
            <td  colspan="2">Rs. {{number_format($payment->discount_amount)}}</td>
        </tr>
        <tr>
            <th>Grand Total</th>
            <th  colspan="2">Rs. {{number_format($payment->total_price + $payment->delivery_cost)}}</th>
        </tr>
