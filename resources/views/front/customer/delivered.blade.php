                            ...
                            <div class="type-page hentry">
                                <header class="entry-header">
                                    <div class="page-header-caption">
                                        <h1 class="entry-title">Completed Orders</h1>
                                    </div>
                                </header>
                                <!-- .entry-header -->
                                <div class="entry-content">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="product-add-to-cart">
                                                        <a class="button add_to_cart_button button alt" href="{{route('customer.complete.order.view',$order->ref_id)}}"> View Details</a>
                                                    </td>
                                    ...
                                    <!-- .wishlist_table -->
                                    @else
                                    YOU HAVEN'T PURCHASED ANY PRODUCTS. <a href="{{route('home.index')}}">BROWSE</a>
                                    @endif
                                </div>
                                <!-- .entry-content -->
                            </div>
