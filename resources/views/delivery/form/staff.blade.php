...
<div class="page-heading">
    <h1 class="page-title">
        <?php if (isset($staff)) {
            echo "Edit";
            $action =  route('delivery.staff.update', $staff->id);
            $button = 'Update';
        } else {
            echo "Add";
            $action = route('delivery.staff.store');
            $button = 'Add';
        }
        ?> Delivery Staff</h1>
...
<form method="POST" id="upload_form" action="{{ $action }}" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="custom-file" style="width:40%">
                    ...
                    <img src="" id="profile-img-tag" width="100px" height="100px" style="display:none;" />
    ...
    <a class="btn btn-warning" href="{{ route('delivery.staff.index') }}">Cancel</a>
</form>
