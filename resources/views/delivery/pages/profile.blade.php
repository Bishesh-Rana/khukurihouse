                ...
                <div class="ibox-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10 form-group">
                            <?php if (isset($delivery->middle_name)) { ?>
                                <p>{{ $delivery->middle_name }}</p>
                            <?php } else { ?>
                                <p style="color:red;">Provide Your Information !</p>
                            <?php } ?>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10 form-group">
                            <?php if (isset($delivery->company_phone)) { ?>
                                <p>{{ $delivery->company_phone }}</p>
                            <?php } else { ?>
                                <p style="color:red;">Provide Your Information !</p>
                            <?php } ?>
                        </div>
            ...
            <div class="ibox ibox-success">
                ...
                <div class="ibox-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10 form-group">
                            <?php if (isset($delivery->company_name)) { ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10 form-group">
                            <?php if (isset($delivery->company_website)) { ?>
                                <p>{{ $delivery->company_website }}</p>
                            <?php } else { ?>
                                <p style="color:red;">Provide Your Information !</p>
                            <?php } ?>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10 form-group">
                            <?php if (isset($delivery->company_description)) { ?>
                                <p>{!! $delivery->company_description !!}</p>
                            <?php } else { ?>
                                <p style="color:red;">Provide Your Information !</p>
                            <?php } ?>
                        </div>
            ...
            <div class="ibox ibox-success">
                ...
                <div class="ibox-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10 form-group">
                            <?php if (isset($delivery->company_country)) { ?>
                                <p>{{ $delivery->company_country }}</p>
                            <?php } else { ?>
                                <p style="color:red;">Provide Your Information !</p>
                            <?php } ?>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10 form-group">
                            <?php if (isset($delivery->company_city)) { ?>
                                <p>{{ $delivery->company_city }}</p>
                            <?php } else { ?>
                                <p style="color:red;">Provide Your Information !</p>
                            <?php } ?>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10 form-group">
                            <?php if (isset($delivery->company_state)) { ?>
                                <p>{{ $delivery->company_state }}</p>
                            <?php } else { ?>
                                <p style="color:red;">Provide Your Information !</p>
                            <?php } ?>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10 form-group">
                            <?php if (isset($delivery->zip_code)) { ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10 form-group">
                            <?php if (isset($delivery->company_address)) { ?>
                                <p>{{ $delivery->company_address }}</p>
                            <?php } else { ?>
                                <p style="color:red;">Provide Your Information !</p>
                            <?php } ?>
                        </div>
            ...
            <div class="ibox ibox-success">
                ...
                <div class="ibox-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10 form-group">
                            <?php if (isset($delivery->bank_name)) { ?>
                                <p>{{ $delivery->bank_name }}</p>
                            <?php } else { ?>
                                <p style="color:red;">Provide Your Information !</p>
                            <?php } ?>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10 form-group">
                            <?php if (isset($delivery->bank_acc_number)) { ?>
                                <p>{{ $delivery->bank_acc_number }}</p>
                            <?php } else { ?>
                                <p style="color:red;">Provide Your Information !</p>
                            <?php } ?>
                        </div>
...
<a href="{{ route('delivery.form.edit') }}" class="btn btn-primary btn-lg">Update Your Profile Information</a>
