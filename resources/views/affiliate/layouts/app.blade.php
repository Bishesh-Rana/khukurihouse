                ...
                <ul class="nav navbar-toolbar">
                    ...
                    <li class="dropdown dropdown-user">
                        <a class="nav-link dropdown-toggle link" data-toggle="dropdown">
                            @if(isset(Auth::guard('affiliate')->user()->image))
                            <img src="{{asset('')}}uploads/affiliates/{{Auth::guard('affiliate')->user()->image}}" />
                            @endif
                            <span></span>{{Auth::guard('affiliate')->user()->first_name}}<i class="fa fa-angle-down m-l-5"></i></a>
                        <ul class="dropdown-menu dropdown-menu-right">

                            <a class="dropdown-item" href="{{route('affiliate.profile.edit')}}"><i class="fa fa-user"></i>Profile</a>
                            <!-- <a class="dropdown-item" href="profile.html"><i class="fa fa-cog"></i>Settings</a>
                            <a class="dropdown-item" href="javascript:;"><i class="fa fa-support"></i>Support</a> -->
                            <li class="dropdown-divider"></li>
                            <a class="dropdown-item" href="{{url('ns-affiliate/logout')}}"><i class="fa fa-power-off"></i>Logout</a>
                        </ul>
                    </li>
                </ul>
