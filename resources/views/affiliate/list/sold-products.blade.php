...
<div class="page-content fade-in-up">
    <div class="ibox">
        <div class="ibox-head">
            <div class="ibox-title">Sold Products</div>
        </div>
        <div class="ibox-body">
            ...
            <div id="table-data">
                @include('affiliate.list.ajaxsoldproduct.sold-product')
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.pagination a', function(e) {
            ...
            filterObject.path = "{{ route('affiliate.ajax.product.sold') }}?page=" + filterObject.page;
            serverRequest();
        });
