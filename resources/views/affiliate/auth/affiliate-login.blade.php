...
<body class="bg-silver-300">
    ...
    <div class="content">
        ...
        <form role="form" method="POST" action="{{ route('affiliate.login.submit') }}">
            @csrf
            <h2 class="login-title">Affiliate Login</h2>
            ...
            <div class="form-group d-flex justify-content-between">
                ...
                <a href="{{route('affiliate.password.request')}}">Forgot password?</a>
            </div>
            <div class="form-group">
