...
class CreateAffiliateReturnTransactionOverviewsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_affiliate_return_transaction_overviews', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tbl_affiliate_return_transaction_overviews');
    }
}
